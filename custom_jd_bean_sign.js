...
const jdCookieNode = $.isNode() ? require(process.env.JDPATH + 'jdCookie.js') : '';
const exec = require('child_process').execSync
const fs = require('fs')
const download = require('download');
let resultPath = process.env.JDPATH + "result.txt";
let JD_DailyBonusPath = process.env.JDPATH + "utils/JD_DailyBonus.js";
let outPutUrl = process.env.JDPATH + 'utils';
let NodeSet = process.env.JDPATH + 'CookieSet.json';
